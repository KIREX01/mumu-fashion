...
import { Loader2, Check, Bell, Settings, Trash2, Filter } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8 md:flex md:items-center md:justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Manage your system alerts and preferences.</p>
            </div>
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <Label htmlFor="new-user-page" className="flex flex-col gap-1">
                      <span>New Users</span>
                  ...
                  <div className="flex items-center justify-between">
                    <Label htmlFor="orders-page" className="flex flex-col gap-1">
                      <span>Orders</span>
                  ...
                  <div className="flex items-center justify-between">
                     <Label htmlFor="payment-page" className="flex flex-col gap-1">
                      <span>Payments</span>
                      <span className="font-normal text-xs text-muted-foreground">Notify on payment issues</span>
                    </Label>
                    <Switch 
                      id="payment-page" 
                      checked={preferences.notify_payment_failed}
                      onCheckedChange={(checked) => updatePreferences({ notify_payment_failed: checked })}
                    />
                  </div>
                </CardContent>
              </Card>
